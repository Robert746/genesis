...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Genesiscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"genesiscoin.net", "dnsseed.genesiscoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"genesiscoin.net", "testnet-seed.genesiscoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Genesiscoin is probably already running."), addrBind.ToString().c_str());
        else
