...
uint256 hashGenesisBlock("0xc4461df4271d5e27186c596b1c2e00157327b0a53fe63766c07b3a826fa2f88c");
...
int64 nChainStartTime =  1394928000;    //3/16/2014 00:00:00
int64 nChangeInterval = 31536000;       //365 days
...
const string strMessageMagic = "Genesiscoin Signed Message:\n";
...
{
    // Genesiscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
const unsigned char maxNfactor = 26;
...
static const int64 nTargetTimespan = BLOCKTIME * TORETARGET; // GenesisCoin: every 1 hours
static const int64 nTargetSpacing = BLOCKTIME; // GenesisCoin: 1 minutes
...
// legacy diff-mode
unsigned int static GetNextWorkRequired_legacy(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Genesiscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Genesiscoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        pchMessageStart[2] = 's';
        pchMessageStart[3] = 'c';
        hashGenesisBlock = uint256("0xc4461df4271d5e27186c596b1c2e00157327b0a53fe63766c07b3a826fa2f88c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        //block.nTime = 1394803666
        //block.nNonce = 2101223718
        //block.GetHash = 0xc4461df4271d5e27186c596b1c2e00157327b0a53fe63766c07b3a826fa2f88c


        // Genesis block
        const char* pszTimestamp = "MAR. 14, 2014 Genesiscoin was borned";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x83db4ac17a4d504f10b13ea5d519a97eaddb88f2b895d98450c4d09825a812bf"));
...
unsigned char pchMessageStart[4] = { 0xfa, 0xbf, 0xb5, 0xda }; // Genesiscoin: increase each by adding 1 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GenesiscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GenesiscoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static GenesiscoinMiner(CWallet *pwallet)
{
    printf("GenesiscoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("genesiscoin-miner");
    ...
    try { while (true) {
        ...
        printf("Running GenesiscoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GenesiscoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&GenesiscoinMiner, pwallet));
}
